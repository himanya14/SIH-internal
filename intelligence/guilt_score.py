...
def calculate_guilt_score(
    ...
    """
    Calculate an explainable analytical risk score.

    IMPORTANT:
    This score represents investigative risk/priority.
    It does NOT establish legal guilt.
    """
    ...
    if kingpin_result:
        ...
        kingpin_name = kingpin_result.get(
            "suspect"
        )

        if (
            kingpin_name
            and kingpin_name.lower()
            == suspect.lower()
        ):
